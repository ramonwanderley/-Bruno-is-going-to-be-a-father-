...
const vueuseHead_04d05329 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_b90905c6 = defineNuxtPlugin((nuxtApp) => {
...
const router_545b1a9d = defineNuxtPlugin((nuxtApp) => {
  const routes = [];
  const hooks = {
    "navigate:before": [],
    "resolve:before": [],
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    style: `background-color: ${!$data.confirmed || $data.loading ? "#7EA1C4" : $data.isFather ? "#46FF66" : "#FF4537"}`,
    class: "main-body"
  }, _attrs))}>`);
  if (!$data.loading && $data.confirmed) {
    _push(`<div class="pyro"><div class="before"></div><div class="after"></div></div>`);
  } else {
    _push(`<!---->`);
  }
  if ($data.loading) {
    _push(`<div class="loader loader--style8" title="7"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="96px" height="120px" viewBox="0 0 24 30" style="${serverRenderer.exports.ssrRenderStyle({ "enable-background": "new 0 0 50 50" })}" xml:space="preserve"><rect x="0" y="10" width="4" height="10" fill="#333" opacity="0.2"><animate attributeName="opacity" attributeType="XML" values="0.2; 1; .2" begin="0s" dur="0.6s" repeatCount="indefinite"></animate><animate attributeName="height" attributeType="XML" values="10; 20; 10" begin="0s" dur="0.6s" repeatCount="indefinite"></animate><animate attributeName="y" attributeType="XML" values="10; 5; 10" begin="0s" dur="0.6s" repeatCount="indefinite"></animate></rect><rect x="8" y="10" width="4" height="10" fill="#333" opacity="0.2"><animate attributeName="opacity" attributeType="XML" values="0.2; 1; .2" begin="0.15s" dur="0.6s" repeatCount="indefinite"></animate><animate attributeName="height" attributeType="XML" values="10; 20; 10" begin="0.15s" dur="0.6s" repeatCount="indefinite"></animate><animate attributeName="y" attributeType="XML" values="10; 5; 10" begin="0.15s" dur="0.6s" repeatCount="indefinite"></animate></rect><rect x="16" y="10" width="4" height="10" fill="#333" opacity="0.2"><animate attributeName="opacity" attributeType="XML" values="0.2; 1; .2" begin="0.3s" dur="0.6s" repeatCount="indefinite"></animate><animate attributeName="height" attributeType="XML" values="10; 20; 10" begin="0.3s" dur="0.6s" repeatCount="indefinite"></animate><animate attributeName="y" attributeType="XML" values="10; 5; 10" begin="0.3s" dur="0.6s" repeatCount="indefinite"></animate></rect></svg></div>`);
  } else {
    _push(`<div class="center"><div class="row"><p class="main-text"> \u{1F931}\u{1F3FC} </p><p style="${serverRenderer.exports.ssrRenderStyle({ "opacity": "0.5" })}" class="main-text"> Bruno vai ser pai? </p></div><div class="row"><p class="main-text" style="${serverRenderer.exports.ssrRenderStyle({ "color": "white" })}">${serverRenderer.exports.ssrInterpolate(!$data.confirmed ? "50% de chance \u{1F9F8}" : $data.isFather ? "Sim \u{1F973}" : "N\xE3o \u{1F973}")}</p></div><div class="row"><p class="secondary-text"> \u{1F914}\u{1FA78} <span style="${serverRenderer.exports.ssrRenderStyle({ "opacity": "0.5" })}">${serverRenderer.exports.ssrInterpolate($data.days)} dias sem descer</span> \u{1FA78}\u{1F914} </p></div></div>`);
  }
  _push(`</div>`);
}
